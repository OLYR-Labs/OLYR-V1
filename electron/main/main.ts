...
import { completeMixedSale } from "../ipc/mixed-payment";
...
function registerIpc(){
 ...
 ipcMain.handle("pos:complete-sale",(_e,input)=>completeSale(input)); ipcMain.handle("pos:complete-mixed-sale",(_e,input)=>completeMixedSale(input)); ipcMain.handle("pos:sales",(_e,id:string)=>salesHistory(id)); ipcMain.handle("pos:inventory",(_e,id:string)=>inventory(id)); ipcMain.handle("pos:profit",(_e,id:string)=>profitReport(id));
